...
-- التعديل هنا: تحديد المسار المباشر بدلاً من البحث عن متغيرات بيئة معدومة
local build_script_path = "AmethystAPI/mod_build.lua"
...
if not os.isfile(build_script_path) then
    ...
    build_mod(mod_name, build_config)
end
